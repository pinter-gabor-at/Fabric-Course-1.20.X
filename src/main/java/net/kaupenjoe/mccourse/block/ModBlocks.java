...
public class ModBlocks {
	...
	public static Block CATTAIL_CROP;
	public static Block COLORED_LEAVES;
	...
	public static void registerModBlocks() {
		...
		CATTAIL_CROP = registerBlockWithoutBlockItem("cattail_crop",
			new CattailCropBlock(FabricBlockSettings.copyOf(Blocks.WHEAT)));
		COLORED_LEAVES = registerBlock("colored_leaves",
