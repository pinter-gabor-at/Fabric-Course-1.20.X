...
public class ModBlockEntities {
	...
	public static void registerBlockEntities() {
		...
		MOD_SIGN_BLOCK_ENTITY = Registry.register(Registries.BLOCK_ENTITY_TYPE,
			new ModIdentifier("mod_sign_entity"),
			FabricBlockEntityTypeBuilder
				.create(
					ModSignBlockEntity::new,
					ModBlocks.DRIFTWOOD_SIGN, ModBlocks.DRIFTWOOD_WALL_SIGN)
				.build());
		MOD_HANGING_SIGN_BLOCK_ENTITY = Registry.register(Registries.BLOCK_ENTITY_TYPE,
			new ModIdentifier("mod_hanging_sign_entity"),
			FabricBlockEntityTypeBuilder
				.create(
					ModHangingSignBlockEntity::new,
					ModBlocks.DRIFTWOOD_HANGING_SIGN, ModBlocks.DRIFTWOOD_HANGING_WALL_SIGN)
				.build(null));
	}
}
