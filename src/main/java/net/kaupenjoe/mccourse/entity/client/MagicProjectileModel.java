	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData bb_main = modelPartData.addChild("bb_main",
			ModelPartBuilder.create()
				.uv(0, 0)
				.cuboid(-1.0F, -4.0F, -1.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F))
				.uv(8, 0)
				.cuboid(-1.0F, -5.0F, 0.0F, 2.0F, 4.0F, 0.0F, new Dilation(0.0F))
				.uv(0, 6)
				.cuboid(-2.0F, -4.0F, 0.0F, 4.0F, 2.0F, 0.0F, new Dilation(0.0F)),
			ModelTransform.pivot(0.0F, 24.0F, 0.0F));
		ModelPartData cube_r1 = bb_main.addChild("cube_r1",
			ModelPartBuilder.create()
				.uv(0, 4)
				.cuboid(-2.0F, -1.0F, 0.0F, 4.0F, 2.0F, 0.0F, new Dilation(0.0F))
				.uv(0, 8)
				.cuboid(-1.0F, -2.0F, 0.0F, 2.0F, 4.0F, 0.0F, new Dilation(0.0F)),
