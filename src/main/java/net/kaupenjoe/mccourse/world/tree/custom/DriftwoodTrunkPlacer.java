...
public class DriftwoodTrunkPlacer extends TrunkPlacer {
	public static final Codec<DriftwoodTrunkPlacer> CODEC =
		RecordCodecBuilder.create(driftwoodTrunkPlacerInstance ->
			fillTrunkPlacerFields(driftwoodTrunkPlacerInstance)
				.apply(driftwoodTrunkPlacerInstance, DriftwoodTrunkPlacer::new));
	...
	public List<FoliagePlacer.TreeNode> generate(TestableWorld world, BiConsumer<BlockPos, BlockState> replacer, Random random,
		...
		int trueHeight = height + random.nextBetween(firstRandomHeight, firstRandomHeight + 3) +
		...
		return ImmutableList.of(new FoliagePlacer.TreeNode(startPos.up(trueHeight), 0, false));
	}
}
