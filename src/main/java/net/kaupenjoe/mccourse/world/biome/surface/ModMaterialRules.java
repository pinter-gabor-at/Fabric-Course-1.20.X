...
public class ModMaterialRules {
	...
	private static final MaterialRules.MaterialRule PINK_GARNET =
		makeStateRule(ModBlocks.PINK_GARNET_BLOCK);
	private static final MaterialRules.MaterialRule RAW_PINK_GARNET =
		makeStateRule(ModBlocks.RAW_PINK_GARNET_BLOCK);

	public static MaterialRules.MaterialRule makeRules() {
		MaterialRules.MaterialCondition isAtOrAboveWaterLevel =
