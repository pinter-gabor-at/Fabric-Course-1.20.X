...
import net.kaupenjoe.mccourse.item.custom.DiceItem;
...
import net.kaupenjoe.mccourse.item.custom.RadiationStaffItem;
...
public class ModItems {
	...
	public static Item CATTAIL_SEEDS;
	...
	public static void registerModItems() {
		...
		DICE = registerItem("dice",
			new DiceItem(new FabricItemSettings()));
		DRIFTWOOD_BOAT = TerraformBoatItemHelper
			.registerBoatItem(ModBoats.DRIFTWOOD_BOAT_ID, ModBoats.DRIFTWOOD_BOAT_KEY, false);
		DRIFTWOOD_CHEST_BOAT = TerraformBoatItemHelper
			.registerBoatItem(ModBoats.DRIFTWOOD_CHEST_BOAT_ID, ModBoats.DRIFTWOOD_BOAT_KEY, true);
		CATTAIL_SEEDS = registerItem("cattail_seeds",
